...
def get_memory_service():
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "6606123145399107584"
    if agent_engine_id:
        from google.adk.memory import VertexAiMemoryBankService

        return VertexAiMemoryBankService(
            project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-7b04b331c989"),
            location=os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION")
